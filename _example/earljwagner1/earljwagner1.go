...
func main() {
	...
	// 2. tell the interpreter about our compiled function Cube() in package "github.com/steele232/zoumacro/example/earljwagner1"
	...
	imports.Packages["github.com/steele232/zoumacro/example/earljwagner1"] = imports.Package{
	...
	//    ir.ImportPackage("earljwagner1", "github.com/steele232/zoumacro/example/earljwagner1")
	ir.Eval(`import "github.com/steele232/zoumacro/example/earljwagner1"`)
	...
	// 5. tell the interpreter to switch to package "github.com/steele232/zoumacro/example/earljwagner1"
	//    alternatively, at REPL one would type (note the quotes):
	//      package "github.com/steele232/zoumacro/example/earljwagner1"
	ir.ChangePackage("earljwagner1", "github.com/steele232/zoumacro/example/earljwagner1")
	...
	imports.Packages["github.com/steele232/zoumacro/example/earljwagner1"].Binds["Cube"] = ir.ValueOf("Cube")
}
